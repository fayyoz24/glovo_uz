...
from apps.couriers.constants import VehicleType, CourierStatus
...
class CourierProfile(models.Model):
    ...
    photo = models.ImageField(upload_to="couriers/photos/", null=True, blank=True)
    ...
    @property
    def is_online(self):
        return self.courier_status in (
            CourierStatus.ONLINE, CourierStatus.BUSY
        )
