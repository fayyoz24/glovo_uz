...
Muhit o'zgaruvchilari (.env):
    ...
    TELEGRAM_WEBHOOK_SECRET   — webhook secret (Django bilan bir xil)
    TELEGRAM_WEBHOOK_URL      — https://api.yourdomain.uz/api/v1/auth/telegram/webhook/
...
async def _run_webhook(bot: Bot, dp: Dispatcher) -> None:
    ...
    from telegram_bot.config import WEBHOOK_SECRET, WEBHOOK_URL
